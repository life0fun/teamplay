...
if __name__ == '__main__':
    ...
    opts.jid = 'life0fun@gmail.com'
    opts.password = '$KunMing1'
    opts.proxy_host = 'wwwgate0.mot.com'
    opts.proxy_port = 1080
    opts.proxy_user = 'e51141'
    opts.proxy_pass = 'Password123'
    ...
    #if xmpp.connect():
    # can not use ssl, must use tls.
    if xmpp.connect((gtalkserver, 5222), True, True, False):
